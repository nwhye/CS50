...
# for example there Student and Professor, both has names and both has error checking for name
# how to prevent duplicating such things
...
class Student(Wizard):  # to mark super-class, from which inherit
    def __init__(self, name, house):
        super().__init__(name)  # reference to super class, to parent
        self.house = house
